...
<body class="user-select">
                	...
                	if(lis[i].getAttribute("ideal-type")){
                		...
                		switch(text){
                			case 'first':
                				...
                				lis[i].setAttribute('ideal-type', '第一志愿');
                				break;
                			case 'second':
                				lis[i].innerText = '第二志愿';
                				lis[i].setAttribute('ideal-type', '第二志愿');
                				break;
                		};
                	};
                	if(lis[i].getAttribute("is-accept")){
                		...
                		switch(text){
                			...
                			case '2':
                				...
                				break;
                			case '3':
                				lis[i].innerHTML = '<span style="font-weight:bold;color: #269abc;font-size:16px;">等待审核</span>';
                				lis[i].setAttribute('on-see-tip','等待审核');
                				break;
                		};
                	};
    ...
    <!-- 分页开始 -->
	<script type="text/javascript">
		var url = "<%=basePath %>/Ideal_defaultInform.action";                 //获取表单url
		//首页
		function first(){
