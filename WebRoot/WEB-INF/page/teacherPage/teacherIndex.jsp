...
<body>
    ...
    <section class="left">
        ...
        <div class="nav-item">
            <h3  class="bg-df"><i class="glyphicon glyphicon-th-list"></i>课题志愿<span class="fl-r caret"></span></h3>
            <ul class="ds-n">
                <li><a href="<%=basePath%>/Topic_openIdealTopicList.action" target="iframe">志愿审核</a></li>
                <li><a href="<%=basePath%>/Ideal_enrollList.action" target="iframe">录取名单</a></li>
            </ul>
        </div>
        <div class="nav-item">
