	        ...
	        <tbody>
		        <s:iterator value="pageResult.data">
		            <tr>
	                    ...
	                    <td class="topic-topicRequest">${topicRequest}</td>
	                    <td class="topic-topicContent">${topicContent}</td>
	                    <td on-see-tip="点击右边查看详情,可查看更多信息">${issueDate}</td>
	                    <td class="topic-topicSurplus">${topicSurplus}</td>
	                    <td class="topic-instituteName">${instituteName}</td>
	                    <td>
	                    	<button type="button" class="btn btn-info btn-xs" onclick="show_modal(this,'修改课题','modify',${TopicInfoId});">修改</button>
	                    	<button type="button" class="btn btn-danger btn-xs" onclick="show_modal(this,'删除课题','del',${TopicInfoId});">删除</button>
	                    </td>
	                </tr>
				</s:iterator>
			</tbody>
